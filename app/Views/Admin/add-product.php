                                ...
                                <div class="wg-box">
                                    ...
                                    <form action="<?= BASE_URL ?>?role=admin&act=add-post-product" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" id="price-sale" placeholder="Price Sale" name="pricesale" class="form-control">
                                        </div>

                                        <div class="mb-5">
                                            <label for="stock">Stock</label>
                                            <input type="text" id="stock" placeholder="Stock" name="stock" class="form-control">
                                        </div>
                    ...
                    <div class="mt-4 mb-4">
                        <span>Hình ảnh</span>
                            <div class="d-flex">
                                ...
                                <button class="btn-sm btn btn-danger btn-delete">Xóa</button></div>
                            </div>
                    `;
