                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="<?=BASE_URL?>" class="logo-header">
                            <img src="assets/Admin/upload/logor.png" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                <li class="menu-item">
                                    <a href="http://localhost/DuAnSiuCapVipPro/" class="item-link">Home</a>

                                </li>

                                <li class="menu-item">
                                    <a href="<?= BASE_URL ?>?act=shop" class="item-link">Products</i></a>
                                </li>
                                <li class="menu-item position-relative">
                                    <a href="#" class="item-link">Pages</i></a>
                                </li>
                                <li class="menu-item position-relative">
                                    <a href="#" class="item-link">Blog</i></a>
                                </li>    
                            </ul>
                        </nav>
                    </div>
