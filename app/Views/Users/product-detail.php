...
<body class="preload-wrapper popup-loader">
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-info-wrap sticky-top">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-price">
                                        ...
                                        <div class="badges-on-sale">
                                            <span>
                                                <?= isset($product->price_sale, $product->price) && $product->price > 0
                                                    ? round((1 - (floatval($product->price_sale) / floatval($product->price))) * 100, 2)
                                                    : 0 ?>
                                            </span>% OFF
                                        </div>
                                    </div>
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        <a class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn
                                        <?php if (isset($_SESSION['users'])): ?>
                                            btnAddToCart
                                        <?php endif ?>"
                                            <?php if (!isset($_SESSION['users'])): ?>
                                            onclick="alert('Bạn cần đang nhập trước')"
                                            <?php endif ?>><span>Add to cart -&nbsp;</span>
    ...
    <section class="flat-spacing-5 pt_0 flat-seller">
        <div class="container">
            <div class="flat-title">
                <span class="title wow fadeInUp" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
                    ...
                    <div class="card-product fl-item" style="display: block;">
                        <div class="card-product-wrapper">
                            <a href="<?= BASE_URL ?>?act=product-detail&product_id=<?= $value->id ?>"
                                class="product-img">
                                <img class="img-product lazyloaded" data-src="<?= $value->image_main ?>"
                                    src="<?= $value->image_main ?>" alt="image-product">
                                <img class="img-hover ls-is-cached lazyloaded" data-src="<?= $value->image_main ?>"
                                    src="<?= $value->image_main ?>" alt="image-product">
                            </a>
                        ...
                        <div class="card-product-info">
                            <a href="http://localhost/DuAnSiuCapVipPro/?act=product-detail&amp;product_id=47" class="title link"><?= $value->name ?></a>
                            <div style="display: flex;">
                                ...
                                if ($value->price_sale != null): ?>
                                    ...
                                    <span class="price price_sale">
                                        <?= number_format($value->price_sale) ?> $
                                    </span>
                                <?php else: ?>
    ...
    <script>
        ...
        function showCart(data) {
            ...
            $(".tf-totals-total-value").text(tong.toLocaleString() + "$")
        }
